...
//import class a ne create class
    ...
    private void createNewUser() {
        ...
        db.collection(firebaseUser.getUid()).add("products")
    ...
    private void updateUI(FirebaseUser currentUser) {
        if (currentUser == null) {
            ...
            prikaziListu = findViewById(R.id.lista);
            View.OnClickListener listener = new View.OnClickListener() {
            ...
            prikaziListu.setOnClickListener(listener2);

        }
    }

    private void prikaziListu() {
        Intent intent = new Intent(this,ShoppingListaActivity.class);
